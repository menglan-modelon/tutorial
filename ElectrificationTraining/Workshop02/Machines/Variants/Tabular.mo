within ElectrificationTraining.Workshop02.Machines.Variants;

model Tabular "An electric machine with no losses"
  extends .Electrification.Machines.Templates.Machine(
    redeclare replaceable .ElectrificationTraining.Workshop02.Machines.Core.Tabular core,
