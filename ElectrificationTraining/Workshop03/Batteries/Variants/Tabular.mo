...
model Tabular "Battery pack with all cells lumped as one unit"
  extends .Electrification.Batteries.Templates.BatteryPackLumped(
    redeclare replaceable .ElectrificationTraining.Workshop01.Batteries.Core.Tabular core,
    redeclare replaceable .Electrification.Batteries.Electrical.Pack.Ideal electrical,redeclare replaceable .Electrification.Batteries.Thermal.Examples.CommonCell thermal,
